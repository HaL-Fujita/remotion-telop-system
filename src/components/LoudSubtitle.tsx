...
import type { SubtitleEntry, LoudSubtitleStyle } from '../types/telop';

interface LoudSubtitleProps {
  /** 字幕エントリ */
  entry: SubtitleEntry;
  /** スタイル設定 */
  style: LoudSubtitleStyle;
  /** 動画の幅 */
  videoWidth: number;
  /** 動画の高さ */
  videoHeight: number;
...
/**
 * 大音量字幕コンポーネント
 * 赤文字、黄色背景、画面下部中央に表示（通常より大きいフォント）
 */
export const LoudSubtitle: React.FC<LoudSubtitleProps> = ({
  entry,
  style,
  videoWidth,
  videoHeight,
